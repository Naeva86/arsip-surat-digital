...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Surat Keluar</h2>
        <p class="text-sm text-gray-400 mt-0.5">Perbarui informasi surat keluar</p>
    </div>

    <form action="{{ route('surat-keluar.update', $suratKeluar) }}" method="POST" enctype="multipart/form-data"
        data-konfirmasi
        data-tipe="edit"
        data-judul="Perbarui Surat Keluar?"
        data-pesan="Data lama akan ditimpa dengan data baru."
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="nomor_surat"
                           ...
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('nomor_surat') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="penerima"
                           ...
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('penerima') border-red-400 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="judul_surat"
                           ...
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('judul_surat') border-red-400 @enderror">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-5">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Tanggal Surat <span class="text-red-500 normal-case">*</span></label>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Tanggal Arsip <span class="text-red-500 normal-case">*</span></label>
                    <input type="date" name="tanggal_arsip"
                           value="{{ old('tanggal_arsip', $suratKeluar->tanggal_arsip->format('Y-m-d')) }}"
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                </div>
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5 uppercase tracking-wider">Sifat Surat <span class="text-red-500 normal-case">*</span></label>
                    <div class="flex flex-col gap-2">
                        ...
                        <label class="sifat-label flex items-center gap-2 px-3 py-2.5 border rounded-lg cursor-pointer transition
                            {{ old('sifat', $suratKeluar->sifat) === $val ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50' }}">
                            <input type="radio" name="sifat" value="{{ $val }}"
                                   {{ old('sifat', $suratKeluar->sifat) === $val ? 'checked' : '' }}
                ...
                <div class="flex flex-col gap-5">
                    <div>
                        ...
                        <select name="kategori_id"
                            ...
                            <option value="{{ $k->id }}" {{ old('kategori_id', $suratKeluar->kategori_id) == $k->id ? 'selected' : '' }}>{{ $k->nama_kategori }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="bagian_id"
                            ...
                            <option value="{{ $b->id }}" {{ old('bagian_id', $suratKeluar->bagian_id) == $b->id ? 'selected' : '' }}>{{ $b->nama_bagian }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text" name="keterangan"
                               value="{{ old('keterangan', $suratKeluar->keterangan) }}"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg px-4 py-3 mb-4">
                    <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                    </svg>
                    <div class="flex-1">
                        <p class="text-xs font-medium text-green-700 dark:text-green-400">File saat ini tersedia</p>
                        <p class="text-xs text-green-600 dark:text-green-500 mt-0.5">Upload file baru untuk mengganti</p>
                    </div>
                    <a href="{{ Storage::url($suratKeluar->file_path) }}" target="_blank"
                       class="text-xs text-green-700 dark:text-green-400 hover:underline font-medium flex-shrink-0">
                        Lihat File →
                    </a>
                </div>
                @endif

                <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30 transition group">
                    <div id="upload-placeholder" class="flex flex-col items-center gap-2 text-center">
                        <svg class="w-7 h-7 text-gray-300 dark:text-gray-600 group-hover:text-blue-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-blue-500 transition">
                                {{ $suratKeluar->file_path ? 'Klik untuk ganti file' : 'Klik untuk upload' }}
                            </p>
                            <p class="text-xs text-gray-400 mt-0.5">PDF • Maks. 10MB</p>
                        </div>
                    </div>
                    <div id="upload-preview" class="hidden flex-col items-center gap-1.5">
