...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Surat Masuk</h2>
        <p class="text-sm text-gray-400 mt-0.5">Perbarui informasi surat masuk</p>
    </div>

    <form action="{{ route('surat-masuk.update', $suratMasuk) }}" method="POST" enctype="multipart/form-data"
        data-konfirmasi
        data-tipe="edit"
        data-judul="Perbarui Surat Masuk?"
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2.5">
                        <span class="text-sm font-mono text-gray-500 dark:text-gray-400">{{ $suratMasuk->no_agenda }}</span>
                    </div>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="judul_surat"
                           value="{{ old('judul_surat', $suratMasuk->judul_surat) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="pengirim"
                           ...
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition @error('pengirim') border-red-400 @enderror">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_arsip"
                           value="{{ old('tanggal_arsip', $suratMasuk->tanggal_arsip->format('Y-m-d')) }}"
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <label class="sifat-label relative flex items-center gap-2 px-3 py-2 border rounded-lg cursor-pointer transition
                            {{ old('sifat', $suratMasuk->sifat) === $val ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50' }}">
                            <input type="radio" name="sifat" value="{{ $val }}"
                                   {{ old('sifat', $suratMasuk->sifat) === $val ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <select name="kategori_id"
                        ...
                        <option value="{{ $k->id }}" {{ old('kategori_id', $suratMasuk->kategori_id) == $k->id ? 'selected' : '' }}>
                            {{ $k->nama_kategori }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="diagendakan_nomor"
                           value="{{ old('diagendakan_nomor', $suratMasuk->diagendakan_nomor) }}"
                ...
                <div>
                    ...
                    <input type="text" name="keterangan"
                           value="{{ old('keterangan', $suratMasuk->keterangan) }}"
                           placeholder="Opsional"
                           class="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
            ...
            <div class="p-6">
                ...
                <label id="upload-area"
                       class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30 transition group">
                    <div id="upload-placeholder" class="flex flex-col items-center gap-2 text-center">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-blue-500 transition">
                                {{ $suratMasuk->file_path ? 'Klik untuk ganti file' : 'Klik untuk upload' }}
                            </p>
