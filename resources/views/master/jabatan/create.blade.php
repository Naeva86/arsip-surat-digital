...
<div class="max-w-lg mx-auto pb-28">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Tambah Jabatan</h2>
        <p class="text-sm text-gray-400 mt-0.5">Isi semua kolom yang diperlukan</p>
    </div>

    <form id="main-form" action="{{ route('master.jabatan.store') }}" method="POST"
          data-konfirmasi data-tipe="simpan" data-judul="Tambah Jabatan?" data-pesan="Jabatan baru akan ditambahkan." data-label-ok="Ya, Tambahkan">
        @csrf
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-5">
            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Nama dan level jabatan</p>
                </div>
            </div>
            <div class="p-6 space-y-5">
                <div>
                    ...
                    <input type="text" name="nama_jabatan" value="{{ old('nama_jabatan') }}" placeholder="Contoh: Dewan Pengawas"
                           class="required-field w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('nama_jabatan') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        @php $isActive = (int) old('level') === $lvl; @endphp
